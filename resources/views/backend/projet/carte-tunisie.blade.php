                    ...
                    <div class="col-12">
                        ...
                        <div class="mapdiv">
                          ...
                          <svg baseprofile="tiny" fill="#7c7c7c" height="2158" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" version="1.2" viewbox="0 0 1000 2158" width="1000" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a xlink:title="tunis" xlink:href="">
                            ...
                            <a xlink:title="Tozeur" xlink:href="{{route('Tozeur',['id'=>'23'])}}">
                            ...
                            <a xlink:title="Manubah" xlink:href="{{route('Manubah',['id'=>'15'])}}">
                            ...
                            <a xlink:title="Béja" xlink:href="{{route('Béja',['id'=>'6'])}}">
                            ...
                            <a xlink:title="Ben_Arous" xlink:href="{{route('Ben_Arous',['id'=>'7'])}}">
                            ...
                            <a xlink:title="Bizerte" xlink:href="{{route('Bizerte',['id'=>'8'])}}">
                            ...
                            <a xlink:title="Jandouba" xlink:href="{{route('Jandouba',['id'=>'9'])}}">
                            ...
                            <a xlink:title="Nabeul" xlink:href="{{route('Nabeul',['id'=>'18'])}}">
                            ...
                            <a xlink:title="Tunis" xlink:href="{{route('Tunis',['id'=>'1'])}}">
                            ...
                            <a xlink:title="Kef" xlink:href="{{route('Kef',['id'=>'13'])}}">
                            ...
                            <a xlink:title="Kassérine" xlink:href="{{route('Kassérine',['id'=>'11'])}}">
                            ...
                            <a xlink:title="Gabés" xlink:href="{{route('Gabés',['id'=>'2'])}}">
                            ...
                            <a xlink:title="Gafsa" xlink:href="{{route('Gafsa',['id'=>'3'])}}">
                            ...
                            <a xlink:title="Sidi Bou Zid" xlink:href="{{route('Sidi_bouzid',['id'=>'19'])}}">
                            ...
                            <a xlink:title="Sfax" xlink:href="{{route('Sfax',['id'=>'4'])}}">
                            ...
                            <a xlink:title="Siliana" xlink:href="{{route('Siliana',['id'=>'20'])}}">
                            ...
                            <a xlink:title="Mahdia" xlink:href="{{route('Mahdia',['id'=>'14'])}}">
                            ...
                            <a xlink:title="Monastir" xlink:href="{{route('Monastir',['id'=>'17'])}}">
                            ...
                            <a xlink:title="Kairouan" xlink:href="{{route('Kairouan',['id'=>'10'])}}">
                            ...
                            <a xlink:title="Sousse" xlink:href="{{route('Sousse',['id'=>'21'])}}">
                            ...
                            <a xlink:title="Zaghouan" xlink:href="{{route('Zaghouen',['id'=>'24'])}}">
                            ...
                            <a xlink:title="Médenine" xlink:href="{{route('Médnine',['id'=>'16'])}}">
                            ...
                            <a xlink:title="Kebili" xlink:href="{{route('Kebili',['id'=>'12'])}}">
                            ...
                            <a xlink:title="Tataouine" xlink:href="{{route('Tataouine',['id'=>'22'])}}">
